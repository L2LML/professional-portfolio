# Project 2 — IT Center Network & Airport Operations Systems Modernization (Technology)

Illustrative, self-directed portfolio project — not a record of an actual Authority engagement. See the [toolkit README](../README.md) for the full scenario and how this pairs with [Project 1 — Construction/Infrastructure](../01-construction-infrastructure-project).

## Scenario

The airport's core network runs on end-of-life switches and a single-threaded fiber backbone — an outage risk for baggage handling, passenger processing, and security systems. This project replaces the network core, migrates those operations systems into the data center built under Project 1, and adds centralized monitoring and cybersecurity hardening, closing with end-user training and a hypercare support period.

| | |
|---|---|
| **Budget** | $2,650,000 (+ $185,000 / 7% contingency) |
| **Duration** | 9 months (starts once Project 1 hands over the facility) |
| **Delivery model** | In-house Network Engineering & Cybersecurity teams + Systems Integrator vendor |
| **Key milestone** | Training, hypercare & project closeout, Month 9 |
